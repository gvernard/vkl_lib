...
DEPS = constants.hpp fitsInterface.hpp jsonParsers.hpp covKernels.hpp rectGrid.hpp imagePlane.hpp massModels.hpp sourceProfile.hpp sourcePlane.hpp   tableDefinition.hpp 
OBJ  = constants.o   fitsInterface.o   jsonParsers.o   covKernels.o   rectGrid.o   imagePlane.o   massModels.o   sourceProfile.o   baseSourcePlane.o fixedSource.o fastell.o
